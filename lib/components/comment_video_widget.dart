...
import 'comment_video_model.dart';
export 'comment_video_model.dart';

class CommentVideoWidget extends StatefulWidget {
  ...
  /// interactions.
  const CommentVideoWidget({
    super.key,
    required this.videoPost,
  });

  final DocumentReference? videoPost;

  @override
  State<CommentVideoWidget> createState() => _CommentVideoWidgetState();
}

class _CommentVideoWidgetState extends State<CommentVideoWidget> {
  late CommentVideoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentVideoModel());
                    ...
                    onPressed: () async {
                      ...
                      _model.ggggg = CommentRecord.getDocumentFromData(
                          createCommentRecordData(
                            text: _model.textController.text, // todo: trim the white spaces
                            userRef: currentUserReference,
                            isReported: false,
                            dateTime: getCurrentTimestamp,
                            videoPost: widget.videoPost,
